...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({animation:"squeeze",outlet:function(e,t,r){return{marginLeft:e&&!r?t+"px":0,marginRight:e&&r?t+"px":0}}})}),define("ember-burger-menu/components/bm-menu-item",["exports","ember-burger-menu/templates/components/bm-menu-item","ember-burger-menu/computed/style-for","ember-burger-menu/utils/is-fastboot"],function(e,t,r,n){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,classNames:["bm-outlet"],attributeBindings:["style"],state:null,style:(0,r.default)("outlet").readOnly()})}),define("ember-burger-menu/components/burger-menu",["exports","ember-burger-menu/templates/components/burger-menu","ember-burger-menu/computed/style-for","ember-burger-menu/mixins/swipe-support","ember-burger-menu/-private/state","ember-lifeline/mixins/dom","ember-burger-menu/utils/is-fastboot"],function(e,t,r,n,i,o,a){"use strict"
...
this._setupEventsTimer=Ember.run.scheduleOnce("afterRender",this,e)}})),_setupEvents:function(){this.get("dismissOnClick")&&(this.addEventListener(document.body,"click",this.onClick),this.addEventListener(document.body,"touchstart",this.onClick)),this.get("dismissOnEsc")&&this.addEventListener(window,"keyup",this.onKeyup)},_teardownEvents:function(){this.removeEventListener(document.body,"click",this.onClick),this.removeEventListener(document.body,"touchstart",this.onClick),this.removeEventListener(window,"keyup",this.onKeyup)},onClick:function(e){var t=this.get("elementId")
0===Ember.$(e.target).closest("#"+t+" .bm-menu").length&&this.get("state.actions").close()},onKeyup:function(e){27===e.keyCode&&this.get("state.actions").close()},onSwipe:function(e,t){var r=this.get("position"),n=this.get("open"),i=this.get("gesturesEnabled"),o=Ember.$(t).closest(".bm-menu").length>0
...
if(r.has&&r.has(e)||!r.has&&(r.entries[e]||r.entries[e+"/index"]))return require(e)[t]}}),define("ember-resolver/features",[],function(){"use strict"})
...
t.DS.BuildURLMixin=t.BuildURLMixin,t.DS.RESTSerializer=m.default,t.DS.JSONSerializer=h.default,t.DS.JSONAPIAdapter=c.default,t.DS.JSONAPISerializer=f.default,t.DS.Transform=i.default,t.DS.DateTransform=a.default,t.DS.StringTransform=s.default,t.DS.NumberTransform=o.default,t.DS.BooleanTransform=u.default,t.DS.EmbeddedRecordsMixin=y.default,t.DS.belongsTo=t.belongsTo,t.DS.hasMany=t.hasMany,t.DS.Relationship=t.Relationship,t.DS._setupContainer=r.default,t.DS._initializeStoreService=n.default,Object.defineProperty(t.DS,"normalizeModelName",{enumerable:!0,writable:!1,configurable:!1,value:t.normalizeModelName}),Object.defineProperty(t.global,"DS",{configurable:!0,get:function(){return t.DS}}),e.default=t.DS})
